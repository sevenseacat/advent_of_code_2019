defmodule Day2 do
  ...
  @doc """
  iex> Day2.run_program(:array.from_list [1,0,0,0,99]) |> :array.to_list
  [2,0,0,0,99]

  iex> Day2.run_program(:array.from_list [2,3,0,3,99]) |> :array.to_list
  [2,3,0,6,99]

  iex> Day2.run_program(:array.from_list [2,4,4,5,99,0]) |> :array.to_list
  [2,4,4,5,99,9801]

  iex> Day2.run_program(:array.from_list [1,1,1,4,99,5,6,0,99]) |> :array.to_list
  [30,1,1,4,2,5,6,0,99]
  """
