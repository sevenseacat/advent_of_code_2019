defmodule Day5Test do
  ...
  describe "run_program/4" do
    ...
    test "jump test #1 - immediate mode" do
      {:halt, {_program, outputs}} =
        Day5.run_program(array([3, 3, 1105, -1, 9, 1101, 0, 0, 12, 4, 12, 99, 1]), [
          0
        ])
    ...
    test "equal test #1 - is equal to 8" do
      {:halt, {_program, outputs}} =
        Day5.run_program(array([3, 9, 8, 9, 10, 9, 4, 9, 99, -1, 8]), [8])
    ...
    test "equal test #1 - is not equal to 8" do
      {:halt, {_program, outputs}} =
        Day5.run_program(array([3, 9, 8, 9, 10, 9, 4, 9, 99, -1, 8]), [33])
    ...
    test "less than test #1 - is less than 8" do
      {:halt, {_program, outputs}} =
        Day5.run_program(array([3, 9, 7, 9, 10, 9, 4, 9, 99, -1, 8]), [2])
    ...
    test "less than test #1 - is not less than 8" do
      {:halt, {_program, outputs}} =
        Day5.run_program(array([3, 9, 7, 9, 10, 9, 4, 9, 99, -1, 8]), [8])
    ...
    test "equal test #2 - is equal to 8" do
      {:halt, {_program, outputs}} =
        Day5.run_program(array([3, 3, 1108, -1, 8, 3, 4, 3, 99]), [8])
    ...
    test "equal test #2 - is not equal to 8" do
      {:halt, {_program, outputs}} =
        Day5.run_program(array([3, 3, 1108, -1, 8, 3, 4, 3, 99]), [1])
    ...
    test "less than test #2 - is less than 8" do
      {:halt, {_program, outputs}} =
        Day5.run_program(array([3, 3, 1107, -1, 8, 3, 4, 3, 99]), [2])
    ...
    test "less than test #2 - is not less than 8" do
      {:halt, {_program, outputs}} =
        Day5.run_program(array([3, 3, 1107, -1, 8, 3, 4, 3, 99]), [8])
    ...
    test "relative sample #1 (day 9)" do
      ...
      {:halt, {_program, outputs}} = Day5.run_program(array(input), [])
    ...
    test "relative sample #2 (day 9)" do
      {:halt, {_program, [output]}} =
        Day5.run_program(array([1102, 34_915_192, 34_915_192, 7, 4, 7, 99, 0]))

      assert 16 == String.length(Integer.to_string(output))
    end

    test "relative sample #3 (day 9)" do
      {:halt, {_program, outputs}} = Day5.run_program(array([104, 1_125_899_906_842_624, 99]))
